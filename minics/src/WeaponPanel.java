...
public class WeaponPanel extends JPanel {
	...
	//	JFrame frame = new JFrame();
	 ...
	 //   frame.setLocation(0,0);
		...
		Thread paintweaponThread = new PaintWeaponThread(this);
	    paintweaponThread.start();
	...
	//    int shot_total = MainPanel.main_role.totalBullet.get(new ShotGun());
	    ...
	    JLabel money_s_label = new JLabel(money+"");
	    ...
	    JLabel ko_s_label = new JLabel(ko+"");
	    ...
	    JLabel distance_s_label = new JLabel(distance+"");
